...
Google Sheet-ийн одоогийн `Үндсэн` tab-ийг анхны төлөв болгон хадгалж, автомат шалгалтаар илэрсэн дараагийн өөрчлөлт бүрийн бүх баганатай хувилбарыг Supabase-ийн хэрэглэгчээр тусгаарласан `sheet_snapshot_history` хүснэгтэд бүртгэнэ. Бусад tab-ийн өөрчлөлт болон хуучин олон tab-тай snapshot-ууд харагдах түүх, KPI нийлбэрт орохгүй. Өмнөх төлөв рүү буцсан өөрчлөлтийг шинэ хугацаагаар бүртгэж, дараалсан ижил шалгалтыг давхар хадгалахгүй. Хадгалалт амжилтгүй бол самбарт мэдэгдэнэ. Шалгалтын хооронд үүсээд буцсан өөрчлөлтийг бүртгэх баталгаа байхгүй.
