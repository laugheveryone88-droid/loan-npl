...
`Хугацаа хэтрэлт онтайм` Google Sheet нь үндсэн мэдээллийн эх сурвалж. Апп нээгдэхэд Supabase-д хадгалсан хамгийн сүүлийн хувилбарыг харуулна. Google Sheet-ийг автоматаар болон тогтсон цагаар шалгахгүй. Зөвхөн админ `Одоо шинэчлэх` товч дарахад `Үндсэн` шийтийн бүх баганыг уншиж, өөрчлөлт илэрвэл аппийн хадгалсан өгөгдөл болон түүхийг шинэчилнэ.
...
Google Sheet-ийн `Үндсэн` tab-ийн 2026-09-04 17:21:17-д хадгалсан төлвийг анхны түүх болгон үлдээсэн. Түүнээс хойш зөвхөн админ гараар шинэчлэх үед өөрчлөлт илэрвэл бүх баганатай шинэ хувилбарыг `sheet_snapshot_history` хүснэгтэд бүртгэнэ. Бусад tab-ийн өөрчлөлт түүх үүсгэхгүй. Өмнөх төлөв рүү буцсан өөрчлөлтийг шинэ хугацаагаар бүртгэж, дараалсан ижил шалгалтыг давхар хадгалахгүй.
